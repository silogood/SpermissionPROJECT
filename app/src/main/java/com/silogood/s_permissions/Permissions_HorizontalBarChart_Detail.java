...
public class Permissions_HorizontalBarChart_Detail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ELV.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                showInstalledAppDetails(Permissions_HorizontalBarChart_Detail.this, (String) v.getTag());
                return false;
            }
        });
        ...
        PermissionAdapter mAdapter = new PermissionAdapter(
                Permissions_HorizontalBarChart_Detail.this,
                mGroupData_S,
        ...
        public View getGroupView(int groupPosition, boolean isExpanded,
            ...
            des.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(Permissions_HorizontalBarChart_Detail.this);
