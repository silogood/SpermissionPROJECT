 ...
 */
public class Permissions_PieChart_Detail extends AppCompatActivity implements Runnable {
    private static final String TAG = "Permissions_Tab";
    ...
    protected void onCreate(android.os.Bundle savedInstanceState) {                                             // 1. 오픈
        ...
        ELV.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView parent, View v, int groupPosition, int childPosition, long id) {
                showInstalledAppDetails(Permissions_PieChart_Detail.this, (String) v.getTag());
                return false;
            }
        });
    ...
    private final Handler handler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            PermissionAdapter mAdapter = new PermissionAdapter(
                    Permissions_PieChart_Detail.this,
        ...
        public View getGroupView(int groupPosition, boolean isExpanded,
            ...
            des.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(Permissions_PieChart_Detail.this);
